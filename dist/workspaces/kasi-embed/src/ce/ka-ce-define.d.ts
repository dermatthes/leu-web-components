 ...
 */
export function ka_ce_define(elementName: string, controller: (arg0: $tpl, arg1: {
    template: any;
    $scope: {};
    _error(msg: any): void;
...
}, arg4: $container, arg5: KaToolsV1.Container) => any, template?: HTMLTemplateElement | Promise<HTMLTemplateElement>, options?: {
    waitEvent: any;
    shadowDom: boolean;
    shadowDomOptions: {
        mode: string;
