 ...
 */
KaToolsV1.domReady = () => __awaiter(this, void 0, void 0, function* () {
 ...
 */
KaToolsV1.debounce = (min, max = null) => __awaiter(this, void 0, void 0, function* () {
    if (max === null)
        max = min;
        ...
        let registerEventHandler = function (element, action, callbackOrCode, scope) {
            ...
            element._ka_on[action] = (e) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (typeof callbackOrCode === "function") {
                    return callbackOrCode(...yield KaToolsV1.provider.arguments(callbackOrCode, Object.assign(Object.assign({}, scope), { "$event": e, "$this": element, "$scope": scope })));
                }
                else {
            ...
            case "bindarray":
                ...
                if (typeof r === "undefined") {
                    ...
                    if (selector.hasAttribute("ka.bind.default")) {
                        ...
                        scope = Object.assign(Object.assign({ $scope: scope }, scope), { __curVal: KaToolsV1.eval(selector.getAttribute("ka.bind.default"), scope, selector) });
 ...
 */
KaToolsV1.ce_define = (elementName, controller, template = null, options = { waitEvent: null }) => __awaiter(this, void 0, void 0, function* () {
...
KaToolsV1.RemoteTemplate = class {
    ...
    load() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.tpl === null)
                this.tpl = yield KaToolsV1.loadHtml(this.url);
            return this.tpl;
        });
    }
};
 ...
 * @return {Promise<HTMLTemplateElement>}
 */
KaToolsV1.loadHtml = (url) => __awaiter(this, void 0, void 0, function* () {
    let e = document.createElement("template");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.constructor.__options.waitEvent !== null) {
                ...
                target.addEventListener(eventName, (event) => __awaiter(this, void 0, void 0, function* () {
                    callback(...yield KaToolsV1.provider.arguments(callback, {
                        "$this": this,
                        "$tpl": this.$tpl,
                        "$event": event
                    }));
            ...
            if (callback === null) {
                ...
                this.connected(...yield KaToolsV1.provider.arguments(this.connected, {
                    "$this": this,
                    "$tpl": this.$tpl
                }));
                this.__isConnected = true;
